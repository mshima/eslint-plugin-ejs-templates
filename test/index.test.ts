...
describe('autofix: prefer-encoded (never) and prefer-slurping-codeonly together', () => {
...
describe('fixture tests', () => {
  ...
  test('fixture 3 input has violations (needs prefer-encoded:never and prefer-slurping fixes)', () => {
